###########################################################################
## Makefile generated for Simulink model 'basisSL'. 
## 
## Makefile     : basisSL.mk
## Generated on : Mon Jul 27 00:25:40 2015
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\basisSL.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = basisSL_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = basisSL_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\basisSL.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\basisSL_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=basisSL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\basisSL_grt_rtw\basisSL.cpp $(MATLAB_ROOT)\rtw\c\src\common\rt_cppclass_main.cpp
...
{$(START_DIR)\basisSL_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\basisSL_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
